    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$2, 23, 8, 491);
    			add_location(button1, file$2, 24, 8, 529);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 31, 0, 1130);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    	...
    	const meetups = [
    		{
    			...
    			imageUrl: "https://www.apple.com/newsroom/images/product/services/standard/Apple-Computer-Science-Education-Week-Keep-on-Coding_big.jpg.large.jpg",
    		...
    		},
    		{
    			...
    			imageUrl: "https://aquamermaid.com/cdn/shop/products/Aquamermaid_meetup_5d48595d-225d-413d-8177-f52ac04d2d5f.png?v=1606095586",
    			address: "27th Nerd Road, 32523 New York",
